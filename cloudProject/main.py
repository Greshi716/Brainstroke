...
avg_glucose_level=col7.slider("Enter glucose level",55.12,271.74,105.94)
bmi=col8.slider("Enter bmi",14.00,48.90,28.49)
...
oldpeak=col16.slider("ST depression induced by exercise relative to rest",0.00,6.20,1.03)
